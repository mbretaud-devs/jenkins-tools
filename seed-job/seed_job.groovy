...
def existingCred = findCredentialsById("token-github", domain)
println("existingCred: "+existingCred)
...
//            // 2016-03-08 when we build in the folder "gateway-sftp-DEVELOP", we have a problem on Kerberos authentication.
//            // TODO recreate UDD environment.
//            if (jobName.startsWith("gateway-sftp")) {
//                jobNameToUSe = "please-" + jobName
//            }
//
